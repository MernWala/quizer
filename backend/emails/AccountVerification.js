...
const AccountVerificationEmail = (url="DUMMY_LINK") => {
    const content = `
        ...
        <p style="margin: 15px 0; text-align: center;">
            <a href="${url}" style="display: inline-block; padding: 12px 20px; font-size: 16px; color: #ffffff; background-color: #032325; text-decoration: none; border-radius: 5px;">Verify My Account</a>
        </p>
